...
4. For each year, check the top 6 fuel type for egrid
```{r}
...
5. Combine them into one dataset
```{r}
...
6. check if there's missing data
```{r, message = FALSE}
...
7. Plot the trend for generating capacity over 2018-2023 for wind, solar, and hydro
```{R, message = FALSE}
...
9. Plot the trend for generation over 2018-2023 for wind, solar, and hydro
```{r, message = FALSE}
...
10. combine them together to help compare
```{r}
# Graph 1
...
11. For each year, find the top 5 states for wind, solar, and hydro
```{r}
...
12. Change the display of the tables
```{r}
# years and top-N
years <- 2018:2023
top_n <- 5
