...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 30. Annual installed Wind capacity in Texas from 2018 to 2023."}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 31 . Annual  Wind Generation in Texas from 2018 to 2023."}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 32. Annual number of Wind plants in Texas from 2018 to 2023."}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 33. Annual installed Solar capacity in California from 2018 to 2023."}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 34. Annual installed Solar Generation in California from 2018 to 2023."}
plot_generation_trend(solar_CA, "Solar", "CA")
```

The solid line represents observed total Generation, while the dashed line shows a fitted linear trend. The figure illustrates year-to-year changes in infrastructure expansion and highlights the overall direction and magnitude of long-term growth.

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 35. Annual number of Solar plants in California from 2018 to 2023."}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 36. Annual installed Hydro capacity in Washington from 2018 to 2023."}
plot_capacity_trend(hydro_WA, "Hydro", "WA")
```

The solid line represents observed total nameplate capacity, while the dashed line shows a fitted linear trend. The figure illustrates year-to-year changes in infrastructure expansion and highlights the overall direction and magnitude of long-term growth.
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 37. Annual installed Hydro Generation in Washington from 2018 to 2023."}
plot_generation_trend(hydro_WA, "Hydro", "WA")
```

The solid line represents observed total Generation, while the dashed line shows a fitted linear trend. The figure illustrates year-to-year changes in infrastructure expansion and highlights the overall direction and magnitude of long-term growth.
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Figure 38. Annual number of Hydro plants in Washington from 2018 to 2023."}
...
Overall, the analysis suggests that solar and wind development exhibit momentum effects—states that started ahead tended to grow faster—while hydro capacity remained relatively stable or slightly declined over time.
