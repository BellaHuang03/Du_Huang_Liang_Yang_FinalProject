...
ts2018 <- read.csv(here("egrid_Data/time_series/ts2018.csv"), stringsAsFactors = TRUE)
ts2019 <- read.csv(here("egrid_Data/time_series/ts2019.csv"), stringsAsFactors = TRUE)
ts2020 <- read.csv(here("egrid_Data/time_series/ts2020.csv"), stringsAsFactors = TRUE)
ts2021 <- read.csv(here("egrid_Data/time_series/ts2021.csv"), stringsAsFactors = TRUE)
ts2022 <- read.csv(here("egrid_Data/time_series/ts2022.csv"), stringsAsFactors = TRUE)
ts2023 <- read.csv(here("egrid_Data/time_series/ts2023.csv"), stringsAsFactors = TRUE)
