...
str(egrid2023_sf)
```
# 4. Map Power Plants Locations
1. 2018 Power Plants Locations - Wind Power
...
2. 2018 Power Plants Locations - hydro Power
...
```
2. 2018 Power Plants Locations - solar Power
...
```
2. 2023 Power Plants Locations - wind Power
...
```
3. 2023 Power Plants Locations - wind Power - TX
...
ggplot() +
 ...
 geom_sf(
  ...
  labs(
    title = "2018 Wind Power Plants - Texas",
    x = "Longitude",
    y = "Latitude"
  ) +
  my_theme
